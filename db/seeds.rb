...
user_6 = User.create!({ email: 'user2@example.com', password: 'user456', category: 'hospital' })

user_7 = User.create!({ email: 'user3@example.com', password: 'user789', category: 'hospital' })
